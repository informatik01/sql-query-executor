CREATE DATABASE  IF NOT EXISTS `test_shop_admin` /*!40100 DEFAULT CHARACTER SET utf8 */;
USE `test_shop_admin`;
-- MySQL dump 10.13  Distrib 5.6.13, for Win32 (x86)
--
-- Host: localhost    Database: test_shop_admin
-- ------------------------------------------------------
...
-- Dump completed on 2013-09-12  8:06:37
